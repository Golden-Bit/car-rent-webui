...
class HeroBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Altezze solo per layout wide (lo stacked cresce con il contenuto)
    final double height = isWide ? size.height * 0.76 : double.nan;
    ...
    final double rightPanelWidthAtCenter = (width - midLeftX).clamp(280.0, width);
    ...
    final double rightPanelContentMaxWidth = (rightPanelWidthAtCenter - kRightInnerPad * 2)
        .clamp(280.0, 560.0);

    // Calcolo larghezza dinamica del blocco titolo+campo [260..520]
    double _computeFieldWidth(double available) => available.clamp(260.0, 520.0);
            ...
            child: Container(
              ...
              child: Align(
                ...
                child: SizedBox(
                  ...
                  child: Center(
                    child: Padding(
                      padding: const EdgeInsets.symmetric(horizontal: kRightInnerPad),
                      child: ConstrainedBox(
                        constraints: BoxConstraints(maxWidth: rightPanelContentMaxWidth),
                        child: const _RightPanelContent(), // ora è davvero centrato nel pannello
                      ),
                    ),
                  ),
                ),
